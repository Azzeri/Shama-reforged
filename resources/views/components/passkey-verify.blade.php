...
@php
    $hasPasskeyRoutes = \Illuminate\Support\Facades\Route::has($optionsRoute)
        && \Illuminate\Support\Facades\Route::has($submitRoute);
@endphp
        ...
        x-data="{
            ...
            async verify() {
                ...
                try {
                    ...
                    Livewire.navigate(response.redirect || '/meals');
                } catch (e) {
